...
export default function PolicyPage() {
  ...
  useEffect(() => {
    ...
    if (typeof window !== "undefined") {
      setCurrentDomain(window.location.hostname.toUpperCase())
    }
  }, [])
...
function FingerprintIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-orange-600">
      ...
      <path d="M12 20V22" /><path d="M12 11V12" />
    </svg>
  )
}
